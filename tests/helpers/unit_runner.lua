...
if
    not pathExists(
        repoRoot .. package.config:sub(1, 1) .. "src" .. package.config:sub(1, 1) .. "Launch.lua"
    )
then
...
prependLuaPath(
    toolRoot .. package.config:sub(1, 1) .. "src" .. package.config:sub(1, 1) .. "compatibility"
)
prependLuaPath(
    repoRoot .. package.config:sub(1, 1) .. "runtime" .. package.config:sub(1, 1) .. "lua"
)
