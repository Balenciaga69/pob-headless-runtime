...
- `src/api/shared/build_guard.lua` now owns repo-facing build readiness checks
- `src/api/build/helpers/code.lua` now owns PoB share-code encoding and decoding helpers
