...
function M:has_remote_import_hashes(importTab)
	...
	return isNonEmptyString(importTab.lastAccountHash) and isNonEmptyString(importTab.lastCharacterHash)
end

function M:get_account_name(importTab)
	return importTab.controls and importTab.controls.accountName and importTab.controls.accountName.buf or nil
end
